...
TW_DEVICE_VERSION := Redmi_K50_HyperOS_2.0.5
TW_LOAD_VENDOR_MODULES := "haptic.ko fts_touch_spi.ko"
TW_SUPPORT_INPUT_AIDL_HAPTICS := true
TW_SUPPORT_INPUT_AIDL_HAPTICS_FQNAME := "IVibrator/vibratorfeature"
TW_CUSTOM_CPU_TEMP_PATH := "/sys/class/thermal/thermal_zone54/temp"
TARGET_USE_CUSTOM_LUN_FILE_PATH := "/config/usb_gadget/g1/functions/mass_storage.usb0/lun.%d/file"
TW_OVERRIDE_SYSTEM_PROPS := "ro.build.date.utc;ro.bootimage.build.date.utc;ro.build.fingerprint"
TW_INCLUDE_LOGICAL := true
TW_SUPER_PARTITION_MOUNTPOINT := /super
